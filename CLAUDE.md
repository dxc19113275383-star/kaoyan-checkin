...
- **P1.1 今日学习聚合页已上线（2026-07-02）**：学习中心置顶通栏卡 → `openToday()`（约 3630 行）一屏聚合三项 quest / 到期复习词 / 错题数 / 长难句待复习数 + 「一键开始」直达第一个未达标项。原"敬请期待"占位页已删，`showLearnView` 未知视图回落 hub。下一步 P1.2 阅读配套题 / P1.5 逻辑题库。
